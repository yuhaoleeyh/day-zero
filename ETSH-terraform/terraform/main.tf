      ...
      Statement = [
        {
          ...
          Effect = "Allow"
          Resource = [
            "arn:aws:logs:ap-southeast-1:${local.account_id}:*/*",
            "arn:aws:dynamodb:ap-southeast-1:${local.account_id}:*/*"
          ]
        }
      ]
    })
      ...
      Statement = [
        {
          ...
          Effect = "Allow"
          Resource = [
            "arn:aws:ecs:ap-southeast-1:${local.account_id}:*/*",
            "arn:aws:cloudwatch:ap-southeast-1:${local.account_id}:*/*"
          ]
        }
      ]
    })
...
# Create a second DynamoDB table.
